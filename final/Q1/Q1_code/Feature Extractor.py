...
for i in range(len(f_names)):
    (filepath, tempfilename) = os.path.split(f_names[i])
    ...
    resnet_feature_np = np.append(resnet_feature_np, filename)
...
np.savetxt('test_full.csv', Resnet_feature_list_np, delimiter=',')
