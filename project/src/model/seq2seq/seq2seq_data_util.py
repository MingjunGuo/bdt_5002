...
def generate_training_list(city="bj",
    ...
    '''
    if use_norm_data:
        aq_train = pd.read_csv('E:/python/5002DM/project/data/after_split/norm_data/bj_aq_train_data.csv')
        meo_train = pd.read_csv('E:/python/5002DM/project/data/after_split/norm_data/bj_meo_train_data.csv')
    else:
        aq_train = pd.read_csv('E:/python/5002DM/project/data/after_split/original_data/bj_aq_train_data.csv')
        meo_train = pd.read_csv('E:/python/5002DM/project/data/after_split/original_data/bj_meo_train_data.csv')
...
def generate_X_test_set(city="bj",
                        ...
                        generate_range=False):
    if use_norm_data:
        aq_dev = pd.read_csv('E:/python/5002DM/project/data/after_split/norm_data/bj_aq_dev_data.csv')
        meo_dev = pd.read_csv('E:/python/5002DM/project/data/after_split/norm_data/bj_meo_dev_data.csv')
    else:
        aq_dev = pd.read_csv('E:/python/5002DM/project/data/after_split/original_data/bj_aq_dev_data.csv')
        meo_dev = pd.read_csv('E:/python/5002DM/project/data/after_split/original_data/bj_meo_dev_data.csv')
...
def generate_aggr_set(city="bj",
                      ...
                      generate_mean=False,
                      generate_range=False,
                      aggr_start_time="2018-4-20 0:00",
                      predict_one_day=False):
    '''
    Args:
        station_list : a list of used stations.
    ...
    '''
    if use_norm_data:
        aq_aggr = pd.read_csv('E:/python/5002DM/project/data/after_split/norm_data/bj_aq_dev_data.csv')
        meo_aggr = pd.read_csv('E:/python/5002DM/project/data/after_split/norm_data/bj_meo_dev_data.csv')
    else:
        aq_aggr = pd.read_csv('E:/python/5002DM/project/data/after_split/original_data/bj_aq_dev_data.csv')
        meo_aggr = pd.read_csv('E:/python/5002DM/project/data/after_split/original_data/bj_meo_dev_data.csv')
...
def generate_dev_set(city="bj",
    ...
    # for y_start_index in range(max_y_start_index, min_y_start_index, 24):
    for y_start_index in range(min_y_start_index, max_y_start_index, 24):
    ...
    y_dev = np.array(y_df_list)
    X_dev = np.array(X_df_list)
    # X_dev = np.concatenate(X_df_list, axis=0)
    # y_dev = np.concatenate(y_df_list, axis=0)

    if predict_one_day:
        # y_day_one_df_list = np.array(y_day_one_df_list)
